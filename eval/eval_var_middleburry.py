...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        var_num = 1
        img_0, img_1, flow = flownet_tools.get_data_middeburry(FLAGS.datadir, False, var_num)
        ...
        slim.evaluation.evaluation_loop(
            ...
            logdir=FLAGS.logdir + '/eval_var_middleburry',
