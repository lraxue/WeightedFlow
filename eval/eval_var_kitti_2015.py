...
flags.DEFINE_string('dataset', '/kitti_2015', 'Data Set in use')
...
def main(_):
    """Evaluate FlowNet for Kitti 2015 test set"""
    ...
    with tf.Graph().as_default():
        ...
        calc_flows = architectures.flownet_dropout(imgs_0_rs, imgs_1_rs, flows_2D)
        ...
        slim.evaluation.evaluation_loop(
            ...
            logdir=FLAGS.logdir + '/eval_var_kitti_2015',
...
if __name__ == '__main__':
    ...
    parser.add_argument(
      '--datadir',
      type=str,
      default='data/Kitti/2015/training/',
